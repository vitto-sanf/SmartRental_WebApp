...
function AreaPersonale_AddP() {
  ...
  return (
    <Page title="Area Personale - Addetto Parcheggio">
      <div className="pt-5 text-font" style={{ backgroundColor: "#f8f9fa" }}>
        <div className="container-fluid mt-5 pb-5 ">
          <div className="row justify-content-center ">
            {/* TESTO SOPRA  */}
            <div className="card col-12 col-md-12 col-lg-12 pb-5">
              ...
              <div className="img-shadow p-5" style={{ backgroundColor: "#bcc8e9" }}>
                ...
                <div className="card-box align-center ">
                  <div className="row justify-content-center">
                    <div className="col-xl-6 col-lg-10 col-md-10 col-sm-10  mb-3">
                    ...
                    <div className="col-xl-6 col-lg-10 col-md-10 col-sm-10  mb-3">
                      <div className="card card-areaP">
                        <div className="card-body">
                          ...
                          <div className="row justify-content-center">
                            <Link to="/notificaInizioCorsa_AddP" className="col-8 btn btn-cards">
                              Notifica Inizio Corsa
                            </Link>
                            <Icon className=" material-icons-outlined md-36 mt-2 ">play_circle</Icon>
                          </div>
                          <div className="row justify-content-center">
                            <Link to="/notificaFineCorsa_AddP" className="col-8 btn btn-cards">
                              Notifica Fine Corsa
                            </Link>
...
export default AreaPersonale_AddP
